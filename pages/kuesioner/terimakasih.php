...
<html lang="en">
  <head>
    ...
    <title>Terimakasih - Kuesioner</title>
  ...
  <body>
    <main>
      <section id="terimakasih" class="terimakasih">
        <div class="container">
          <div class="row content">
            <div class="col-12 col-lg-8">
              <h2 class="title">
                Terimakasih atas jawaban dan partisipasi anda
              </h2>
              <p class="subtitle">
                semua kontribusi anda membuat RSUD Arosuka menjadi lebih baik
                dan bermanfaat!
              </p>
            </div>
            <div class="col-12">
