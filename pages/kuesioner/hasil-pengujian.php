        ...
        <?php
          if (!empty($hasil_pengujian)) {
              ...
              foreach ($hasil_pengujian as $pengujian) {
                  ...
                  echo '<div class="row">';
                  echo '<div class="col-9">Ketanggapan <span>(Responsiveness)</span></div>';
                  echo '<div class="col-3">: ' . $pengujian['responsiveness'] . '</div>';
                  echo '<div class="col-9">Empati <span>(Empathy)</span></div>';
                  echo '<div class="col-3">: ' . $pengujian['empathy'] . '</div>';
                  echo '<div class="col-9">Tampilan Fisik <span>(Tangible)</span></div>';
                  echo '<div class="col-3">: ' . $pengujian['tangible'] . '</div>';
                  echo '</div>';
                  echo '</div>';
