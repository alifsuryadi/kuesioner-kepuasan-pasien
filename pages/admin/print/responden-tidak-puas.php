...
try {
    // Lakukan kueri SQL untuk mengambil data dari tabel survey_form dan nama lengkap dari tabel users
      $query = "SELECT sf.*, sr.Kepuasan, sr.Responsiveness, sr.Empathy, sr.Tangible, u.username AS nama_lengkap
              ...
              WHERE sr.Kepuasan IS NOT NULL AND sr.Kepuasan != 'Puas'";
...
<head>
    ...
    <meta name="description" content="Web Kuesioner Penilaian Tingkat KeTidak Puasan Pasien 
      RSUD Arosuka" />
    <meta name="keywords" content="keusioner, naive bayes, penilaian keTidak Puasan" />
    ...
    <main>
        <section id="print" class="print">
            <div class="content" data-aos="fade-up">
                <h2 class="title">
                    Total Responden Pasien Tidak Puas di RSUD Arosuka
                </h2>
                        ...
                        <tbody>
                            ...
                            foreach ($data_survey_form as $key => $survey_form) {
                                // Periksa apakah kepuasan adalah 'Puas'
                                    ...
                                    echo '<tr>';
                                    echo '<td>' . ($key + 1) . '</td>';
                                    echo '<td class="col-md-2 col-xs-2">' . (isset($survey_form['nama_lengkap']) ? $survey_form['nama_lengkap'] : '') . '</td>';
