...
$data_survey_form = [];
try {
  // Lakukan kueri SQL untuk mengambil data dari tabel survey_form dengan user_id yang gender-nya laki-laki
    ...
    <main>
        <section id="print" class="print">
            <div class="content" data-aos="fade-up">
                <h2 class="title">
                    Total Responden Pasien Laki-laki di RSUD Arosuka
                </h2>
